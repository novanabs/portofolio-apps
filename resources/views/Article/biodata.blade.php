...
<body>
	...
	<br><br><br>
	<img src="{!! URL('uploads/TQdsL7_0871.jpg') !!}" alt="" style="height:90px; margin:0 0 0 540px">
...
<section style="margin:-120px 0 0 0;">
	...
	<table>
		<tbody>
			<tr>
				<td>Nama</td>
				<td>: Novan Alkaf Bahraini Saputra</td>
				<td rowspan="7"> </td>
			</tr>
			<tr>
				<td>TTL </td>
				<td>: Balikpapan, 10 Nopember 1993</td>
			</tr>
			<tr>
				<td>Alamat</td>
				<td>: jalan Raya Sengkaling no. 164</td>
			</tr>
			<tr>
				<td>Jenis Kelamin </td>
				<td>: Laki-laki</td>
