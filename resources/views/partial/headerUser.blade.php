  ...
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
      <ul class="nav navbar-nav">
        ...
        @endif
        <li><a href="{!! route('all.apps')!!}">Gallery</a></li>
      </ul>
      ...
      <ul class="nav navbar-nav navbar-right">
        ...
        <li class="dropdown">          
         ...
         <ul class="dropdown-menu" role="menu">
          ...
          <li class="divider"></li>
          <li><a href="{!! route('account.setting')!!}"><span class="glyphicon glyphicon-wrench" aria-hidden="true"></span>Account Settings</a></li>
